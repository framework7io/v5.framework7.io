(function (global, factory) {
    ...
    (global = global || self, global['floating-action-button-backdrop'] = factory(global.Framework7));
    ...
    /* public/packages/svelte/components/fab-backdrop.svelte generated by Svelte v3.22.3 */
    ...
    class Fab_backdrop extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { class: 3, f7Slot: 0 });
    	}
    }
    ...
    class Fab_buttons extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { class: 2, position: 3 });
    	}
    }
    ...
    /* src/pug/docs-demos/svelte/floating-action-button-backdrop.svelte generated by Svelte v3.22.3 */
    ...
    // (13:10) <FabButton label="Action 2">
    ...
    function create_default_slot_2$2(ctx) {
    	...
    	let t3;
    	let current;
    	const navbar = new Navbar({ props: { title: "FAB Backdrop" } });
    	const fabbackdrop = new Fab_backdrop({});
    	...
    	return {
    		c() {
    			...
    			t0 = space();
    			create_component(fabbackdrop.$$.fragment);
    			t1 = space();
    		...
    		m(target, anchor) {
    			...
    			insert(target, t0, anchor);
    			mount_component(fabbackdrop, target, anchor);
    			insert(target, t1, anchor);
    		...
    		i(local) {
    			...
    			transition_in(fabbackdrop.$$.fragment, local);
    		...
    		o(local) {
    			...
    			transition_out(fabbackdrop.$$.fragment, local);
    		...
    		d(detaching) {
    			...
    			if (detaching) detach(t0);
    			destroy_component(fabbackdrop, detaching);
    			if (detaching) detach(t1);
    ...
    class Floating_action_button_backdrop extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    // Init Svelte App
    const app = new Floating_action_button_backdrop({
