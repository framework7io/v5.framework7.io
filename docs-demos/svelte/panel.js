(function (global, factory) {
    ...
    (global = global || self, global.panel = factory(global.Framework7));
    ...
    /* src/pug/docs-demos/svelte/panel.svelte generated by Svelte v3.22.3 */
    ...
    // (2:2) <Panel resizable left reveal>
    ...
    // (9:2) <Panel resizable right themeDark>
    ...
    // (22:10) <Button raised fill panelOpen="left">
    function create_default_slot_7(ctx) {
    	let t;

    	return {
    		c() {
    			t = text("Open left panel");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (25:10) <Button raised fill panelOpen="right">
    function create_default_slot_5(ctx) {
    	let t;

    	return {
    		c() {
    			t = text("Open right panel");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    function create_default_slot_2$2(ctx) {
    	let t;
    	let current;
    	const navbar = new Navbar({ props: { title: "Panel" } });
    ...
    class Panel_1 extends SvelteComponent {
    	constructor(options) {
    		super();
