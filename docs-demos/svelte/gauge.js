(function (global, factory) {
    ...
    (global = global || self, global.gauge = factory(global.Framework7));
    ...
    /* public/packages/svelte/components/gauge.svelte generated by Svelte v3.22.3 */
    ...
    function create_if_block_2$2(ctx) {
    	...
    	let circle_cx_value;
    	let circle_cy_value;
    	let if_block = /*borderBgColor*/ ctx[2] && create_if_block_3$2(ctx);
    ...
    function create_fragment$8(ctx) {
    	...
    	let if_block0 = /*semiCircle*/ ctx[14] && create_if_block_4$1(ctx);
    	let if_block1 = !/*semiCircle*/ ctx[14] && create_if_block_2$2(ctx);
    	let if_block2 = /*valueText*/ ctx[5] && create_if_block_1$2(ctx);
    	let if_block3 = /*labelText*/ ctx[9] && create_if_block$2(ctx);
    	...
    	return {
			...
			: /*size*/ ctx[0]}`)) {
    			...
    			set_attributes(div, get_spread_update(div_levels, [
    				...
    				dirty & /*restProps, $$restProps*/ 262144 && restProps(/*$$restProps*/ ctx[18])
    			]));
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*className*/ 524288) {
    			 $$invalidate(13, classes = Utils.classNames(className, "gauge"));
    		}
    ...
    function create_default_slot_1(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*iconBadge*/ ctx[3] && create_if_block_3$3(ctx);
    ...
    function create_fragment$9(ctx) {
    	...
    	let current;
    	let dispose;
    	let if_block0 = /*hasIcon*/ ctx[8] && create_if_block_2$3(ctx);
    	...
    	let if_block1 = (typeof /*text*/ ctx[0] !== "undefined" || typeof /*badge*/ ctx[1] !== "undefined") && create_if_block$3(ctx);
    ...
    function create_if_block_2$7(ctx) {
    	...
    	const default_slot_template = /*$$slots*/ ctx[15].default;
    	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[14], null);
    	let if_block = /*resizable*/ ctx[1] && /*resizableHandler*/ ctx[2] && create_if_block_3$6();
    ...
    function create_if_block_2$8(ctx) {
    	...
    	let if_block = (/*strong*/ ctx[0] || /*strongIos*/ ctx[1] || /*strongMd*/ ctx[2] || /*strongAurora*/ ctx[3]) && create_if_block_3$7();
    ...
    function create_if_block$b(ctx) {
    	...
    	const default_slot_template = /*$$slots*/ ctx[18].default;
    	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[17], null);
    	let if_block = (/*strong*/ ctx[0] || /*strongIos*/ ctx[1] || /*strongMd*/ ctx[2] || /*strongAurora*/ ctx[3]) && create_if_block_1$9();
    ...
    /* src/pug/docs-demos/svelte/gauge.svelte generated by Svelte v3.22.3 */
    ...
    function create_default_slot_28(ctx) {
    	...
    	return {
    		c() {
    			p = element("p");
    			p.textContent = "Framework7 comes with Gauge component. It produces nice looking fully responsive SVG gauges.";
    		},
    		m(target, anchor) {
    			insert(target, p, anchor);
    		},
    ...
    // (21:10) <Button onClick={() => gaugeValue = 0 }>
    ...
    // (22:10) <Button onClick={() => gaugeValue = 0.25 }>
    ...
    // (23:10) <Button onClick={() => gaugeValue = 0.5 }>
    ...
    // (24:10) <Button onClick={() => gaugeValue = 0.75 }>
    ...
    // (25:10) <Button onClick={() => gaugeValue = 1 }>
    ...
    function create_default_slot_22(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*gaugeValue*/ 1) button0_changes.onClick = /*func*/ ctx[1];
    			...
    			if (dirty & /*gaugeValue*/ 1) button1_changes.onClick = /*func_1*/ ctx[2];
    			...
    			if (dirty & /*gaugeValue*/ 1) button2_changes.onClick = /*func_2*/ ctx[3];
    			...
    			if (dirty & /*gaugeValue*/ 1) button3_changes.onClick = /*func_3*/ ctx[4];
    			...
    			if (dirty & /*gaugeValue*/ 1) button4_changes.onClick = /*func_4*/ ctx[5];
    ...
    // (8:6) <Block strong class="text-align-center">
    function create_default_slot_21(ctx) {
    	...
    	const gauge = new Gauge({
    			props: {
    				type: "circle",
    				value: /*gaugeValue*/ ctx[0],
    				size: 250,
    				borderColor: "#2196f3",
    				borderWidth: 10,
    				valueText: `${/*gaugeValue*/ ctx[0] * 100}%`,
    				valueFontSize: 41,
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			const gauge_changes = {};
    			if (dirty & /*gaugeValue*/ 1) gauge_changes.value = /*gaugeValue*/ ctx[0];
    			if (dirty & /*gaugeValue*/ 1) gauge_changes.valueText = `${/*gaugeValue*/ ctx[0] * 100}%`;
    			gauge.$set(gauge_changes);
    			const segmented_changes = {};

    			if (dirty & /*$$scope, gaugeValue*/ 65) {
    ...
    // (32:10) <Col class="text-align-center">
    ...
    // (41:10) <Col class="text-align-center">
    ...
    // (58:10) <Col class="text-align-center">
    ...
    // (67:10) <Col class="text-align-center">
    ...
    // (83:10) <Col class="text-align-center">
    ...
    // (97:10) <Col class="text-align-center">
    ...
    // (114:10) <Col class="text-align-center">
    ...
    // (127:10) <Col class="text-align-center">
    ...
    function create_default_slot_2$2(ctx) {
    	...
    	let t7;
    	let current;
    	const navbar = new Navbar({ props: { title: "Gauge" } });
    ...
    function instance$j($$self, $$props, $$invalidate) {
    	let gaugeValue = 0.5;
    	const func = () => $$invalidate(0, gaugeValue = 0);
    	const func_1 = () => $$invalidate(0, gaugeValue = 0.25);
    	const func_2 = () => $$invalidate(0, gaugeValue = 0.5);
    	const func_3 = () => $$invalidate(0, gaugeValue = 0.75);
    	const func_4 = () => $$invalidate(0, gaugeValue = 1);
    	return [gaugeValue, func, func_1, func_2, func_3, func_4];
    }

    class Gauge_1 extends SvelteComponent {
    	constructor(options) {
    		super();
