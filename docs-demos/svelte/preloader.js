(function (global, factory) {
    ...
    (global = global || self, global.preloader = factory(global.Framework7));
    ...
    /* src/pug/docs-demos/svelte/preloader.svelte generated by Svelte v3.22.3 */
    ...
    function create_default_slot_22(ctx) {
    	...
    	return {
    		c() {
    			p = element("p");
    			p.textContent = "How about an activity indicator? Framework7 has a nice one. The F7 Preloader is made with SVG and animated with CSS so it can be easily resized.";
    		},
    		m(target, anchor) {
    ...
    // (15:8) <Col style="background: #000">
    function create_default_slot_19(ctx) {
    	let current;
    	const preloader = new Preloader({ props: { color: "white" } });
    ...
    function create_default_slot_18(ctx) {
    	let current;
    	const preloader = new Preloader({ props: { size: 42 } });
    ...
    // (21:8) <Col style="background: #000">
    function create_default_slot_17(ctx) {
    	let current;
    	const preloader = new Preloader({ props: { size: 42, color: "white" } });
    ...
    // (11:6) <Block strong class="row demo-preloaders align-items-stretch text-align-center">
    ...
    function create_default_slot_14(ctx) {
    	let current;
    	const preloader = new Preloader({ props: { color: "red" } });
    ...
    function create_default_slot_13(ctx) {
    	let current;
    	const preloader = new Preloader({ props: { color: "green" } });
    ...
    function create_default_slot_12(ctx) {
    	let current;
    	const preloader = new Preloader({ props: { color: "orange" } });
    ...
    function create_default_slot_11(ctx) {
    	let current;
    	const preloader = new Preloader({ props: { color: "blue" } });
    ...
    // (27:6) <Block strong class="row text-align-center">
    ...
    function create_default_slot_9(ctx) {
    	...
    	return {
    		c() {
    			t = text("Multi-color (MD-theme only)");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (43:6) <Block strong class="text-align-center">
    function create_default_slot_8(ctx) {
    	let current;
    	const preloader = new Preloader({ props: { color: "multi" } });
    ...
    // (51:10) <Button fill onClick={openIndicator}>
    function create_default_slot_6(ctx) {
    	let t;

    	return {
    		c() {
    			t = text("Open Small Indicator");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (55:10) <Button fill onClick={openDialog}>
    function create_default_slot_5(ctx) {
    	let t;

    	return {
    		c() {
    			t = text("Open Dialog Preloader");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (59:10) <Button fill onClick={openCustomDialog}>
    ...
    function create_default_slot_3(ctx) {
    	...
    	const button2 = new Button({
    			props: {
    				fill: true,
    				onClick: /*openCustomDialog*/ ctx[2],
    	...
    	return {
    		c() {
    			p0 = element("p");
    			p0.innerHTML = `With <b>f7.preloader.show()</b> you can show small overlay with preloader indicator.`;
    			t3 = space();
    			p1 = element("p");
    			create_component(button0.$$.fragment);
    			t4 = space();
    			p2 = element("p");
    			p2.innerHTML = `With <b>f7.dialog.preloader()</b> you can show dialog modal with preloader indicator.`;
    			t8 = space();
    			p3 = element("p");
    			create_component(button1.$$.fragment);
    			t9 = space();
    			p4 = element("p");
    			p4.innerHTML = `With <b>f7.dialog.preloader(&#39;My text...&#39;)</b> you can show dialog preloader modal with custom title.`;
    			t13 = space();
    			p5 = element("p");
    		...
    		m(target, anchor) {
    			...
    			mount_component(button1, p3, null);
    			insert(target, t9, anchor);
    			insert(target, p4, anchor);
    			insert(target, t13, anchor);
    			insert(target, p5, anchor);
    			mount_component(button2, p5, null);
    			current = true;
    		},
    		p(ctx, dirty) {
    ...
    function create_default_slot_2$2(ctx) {
    	...
    	let t8;
    	let current;
    	const navbar = new Navbar({ props: { title: "Preloader" } });
    ...
    function instance$g($$self) {
    	...
    	function openDialog() {
    		f7Instance.dialog.preloader();

    		setTimeout(
    			() => {
    				f7Instance.dialog.close();
    			},
    			2000
    		);
    	}
    	...
    	function openCustomDialog() {
    		f7Instance.dialog.preloader("My text...");
    	...
    	return [openIndicator, openDialog, openCustomDialog];
    }

    class Preloader_1 extends SvelteComponent {
    	constructor(options) {
    		super();
