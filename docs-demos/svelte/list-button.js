(function (global, factory) {
    ...
    (global = global || self, global['list-button'] = factory(global.Framework7));
    ...
    /* src/pug/docs-demos/svelte/list-button.svelte generated by Svelte v3.22.3 */

    function create_default_slot_5(ctx) {
    	let t0;
    	let t1;
    	let current;
    	const listbutton0 = new List_button({ props: { title: "List Button 1" } });
    	const listbutton1 = new List_button({ props: { title: "List Button 2" } });
    	const listbutton2 = new List_button({ props: { title: "List Button 3" } });

    	return {
    		c() {
    			create_component(listbutton0.$$.fragment);
    			t0 = space();
    			create_component(listbutton1.$$.fragment);
    			t1 = space();
    			create_component(listbutton2.$$.fragment);
    		},
    		m(target, anchor) {
    			mount_component(listbutton0, target, anchor);
    			insert(target, t0, anchor);
    			mount_component(listbutton1, target, anchor);
    			insert(target, t1, anchor);
    			mount_component(listbutton2, target, anchor);
    			current = true;
    		},
    		p: noop,
    		i(local) {
    			if (current) return;
    			transition_in(listbutton0.$$.fragment, local);
    			transition_in(listbutton1.$$.fragment, local);
    			transition_in(listbutton2.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(listbutton0.$$.fragment, local);
    			transition_out(listbutton1.$$.fragment, local);
    			transition_out(listbutton2.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			destroy_component(listbutton0, detaching);
    			if (detaching) detach(t0);
    			destroy_component(listbutton1, detaching);
    			if (detaching) detach(t1);
    			destroy_component(listbutton2, detaching);
    		}
    	};
    }
    ...
    function create_default_slot_3(ctx) {
    	...
    	const listbutton0 = new List_button({
    			props: { title: "Red List Button", color: "red" }
    		});

    	const listbutton1 = new List_button({
    			props: {
    				title: "Green List Button",
    				color: "green"
    			}
    		});

    	const listbutton2 = new List_button({
    			props: {
    				title: "Orange List Button",
    				color: "orange"
    			}
    		});
    ...
    function create_default_slot_2$2(ctx) {
    	...
    	let t2;
    	let current;
    	const navbar = new Navbar({ props: { title: "List Button" } });
    ...
    class List_button$1 extends SvelteComponent {
    	constructor(options) {
    		super();
