(function (global, factory) {
    ...
    (global = global || self, global.grid = factory(global.Framework7));
    ...
    function create_if_block_2$5(ctx) {
    	...
    	const default_slot_template = /*$$slots*/ ctx[15].default;
    	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[14], null);
    	let if_block = /*resizable*/ ctx[1] && /*resizableHandler*/ ctx[2] && create_if_block_3$4();
    ...
    function create_if_block$8(ctx) {
    	...
    	const default_slot_template = /*$$slots*/ ctx[15].default;
    	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[14], null);
    	let if_block = /*resizable*/ ctx[1] && /*resizableHandler*/ ctx[2] && create_if_block_1$6();
    	let div_levels = [{ class: /*classes*/ ctx[4] }, restProps(/*$$restProps*/ ctx[6])];
    	let div_data = {};
    ...
    /* src/pug/docs-demos/svelte/grid.svelte generated by Svelte v3.22.3 */
    ...
    function create_default_slot_118(ctx) {
    	...
    	return {
    		c() {
    			p = element("p");
    			p.textContent = "Columns within a row are automatically set to have equal width. Otherwise you can define your column with pourcentage of screen you want.";
    		},
    		m(target, anchor) {
    			insert(target, p, anchor);
    		},
    ...
    // (115:10) <Col width="100" medium="50">
    function create_default_slot_39(ctx) {
    	let t;

    	return {
    		c() {
    			t = text(".col-100.medium-50");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (116:10) <Col width="100" medium="50">
    ...
    // (119:10) <Col width="50" medium="25">
    function create_default_slot_36(ctx) {
    	let t;

    	return {
    		c() {
    			t = text(".col-50.medium-25");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (125:10) <Col width="100" medium="40">
    function create_default_slot_31(ctx) {
    	let t;

    	return {
    		c() {
    			t = text(".col-100.medium-40");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (126:10) <Col width="50" medium="60">
    function create_default_slot_30(ctx) {
    	let t;

    	return {
    		c() {
    			t = text(".col-50.medium-60");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (127:10) <Col width="50" medium="66">
    function create_default_slot_29(ctx) {
    	let t;

    	return {
    		c() {
    			t = text(".col-50.medium-66");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (128:10) <Col width="100" medium="33">
    function create_default_slot_28(ctx) {
    	let t;

    	return {
    		c() {
    			t = text(".col-100.medium-33");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    function create_default_slot_26(ctx) {
    	...
    	return {
    		c() {
    			p = element("p");
    			p.textContent = "Grid cells have different size on Phone/Tablet";
    			t1 = space();
    			create_component(row0.$$.fragment);
    			t2 = space();
    			create_component(row1.$$.fragment);
    ...
    // (135:10) <Col resizable style="min-width: 20px">
    ...
    // (136:10) <Col resizable style="min-width: 20px">
    ...
    // (137:10) <Col resizable style="min-width: 20px">
    ...
    // (133:6) <Block class="grid-resizable-demo">
    ...
    function create_default_slot_18(ctx) {
    	...
    	return {
    		c() {
    			t = text("2nd column has fixed size");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (145:10) <Col resizable style="min-width: 20px">
    ...
    // (146:10) <Col resizable resizableFixed style="min-width: 20px">
    ...
    // (147:10) <Col resizable style="min-width: 20px">
    ...
    // (143:6) <Block class="grid-resizable-demo">
    ...
    // (154:10) <Col resizable class="demo-col-center-content" style="min-width: 50px">
    ...
    // (157:14) <Col class="demo-col-center-content" style="height: 100%">
    ...
    // (156:12) <Row resizable style="height: 50%; min-height: 50px">
    function create_default_slot_9(ctx) {
    	let current;

    	const col = new Col({
    			props: {
    				class: "demo-col-center-content",
    				style: "height: 100%",
    ...
    // (160:14) <Col class="demo-col-center-content" style="height: 100%">
    function create_default_slot_8(ctx) {
    	let t;

    	return {
    		c() {
    			t = text("Center Bottom");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (159:12) <Row resizable style="height: 50%; min-height: 50px">
    ...
    // (155:10) <Col resizable class="display-flex flex-direction-column" style="padding: 0px; border: none; min-width: 50px; background-color: transparent">
    function create_default_slot_6(ctx) {
    	...
    	const row0 = new Row({
    			props: {
    				resizable: true,
    				style: "height: 50%; min-height: 50px",
    ...
    // (163:10) <Col resizable class="demo-col-center-content" style="min-width: 50px">
    ...
    // (153:8) <Row class="align-items-stretch" style="height: 300px">
    ...
    // (152:6) <Block class="grid-resizable-demo">
    ...
    function create_default_slot_2$2(ctx) {
    	...
    	let t15;
    	let current;
    	const navbar = new Navbar({ props: { title: "Grid / Layout" } });
