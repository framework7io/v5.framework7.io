(function (global, factory) {
    ...
    (global = global || self, global.subnavbar = factory(global.Framework7));
    ...
    function create_if_block_2$5(ctx) {
    	...
    	let if_block = (/*strong*/ ctx[0] || /*strongIos*/ ctx[1] || /*strongMd*/ ctx[2] || /*strongAurora*/ ctx[3]) && create_if_block_3$4();
    ...
    function create_if_block$8(ctx) {
    	...
    	const default_slot_template = /*$$slots*/ ctx[18].default;
    	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[17], null);
    	let if_block = (/*strong*/ ctx[0] || /*strongIos*/ ctx[1] || /*strongMd*/ ctx[2] || /*strongAurora*/ ctx[3]) && create_if_block_1$6();
    ...
    function create_fragment$e(ctx) {
    	...
    	let if_block_anchor;
    	let current;
    	const if_block_creators = [create_if_block$8, create_if_block_2$5];
    	const if_blocks = [];
    ...
    function create_if_block$9(ctx) {
    	...
    	let t;
    	let current;
    	let if_block = /*title*/ ctx[0] && create_if_block_1$7(ctx);
    	const default_slot_template = /*$$slots*/ ctx[9].default;
    	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[8], null);
    ...
    class Tab extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$g, create_fragment$g, safe_not_equal, { class: 4, tabActive: 5, show: 6 });
    	}
    ...
    /* src/pug/docs-demos/svelte/subnavbar.svelte generated by Svelte v3.22.3 */
    ...
    function create_default_slot_9(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			mount_component(segmented, target, anchor);
    			current = true;
    		},
    		p(ctx, dirty) {
    			...
    			if (dirty & /*$$scope*/ 1) {
    				segmented_changes.$$scope = { dirty, ctx };
    			}
    		...
    		d(detaching) {
    			destroy_component(segmented, detaching);
    		}
    	};
    }

    // (4:6) <Navbar title="Subnavbar">
    ...
    function create_default_slot_7(ctx) {
    	...
    	return {
    		c() {
    			p0 = element("p");
    			p0.textContent = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nisi nisi, tincidunt ut eleifend non, sagittis a elit. Sed consequat odio at leo varius viverra. Proin et purus eu justo lacinia efficitur in sed orci. Morbi dignissim accumsan felis, at malesuada lorem aliquet finibus. Duis vitae enim a mauris luctus lobortis ac vel dolor. Aenean id pretium quam. Duis sed sem ullamcorper erat venenatis feugiat sed pretium magna. Suspendisse massa lectus, dictum congue arcu quis, auctor vulputate lectus. Duis vitae finibus purus, nec condimentum dui. Sed ultricies mauris vitae libero mollis lobortis. Duis ut tortor scelerisque, volutpat metus eget, rutrum est. Integer diam ex, condimentum vel orci a, lobortis bibendum urna. Aenean porttitor, eros sit amet ultrices efficitur, libero odio rhoncus justo, quis volutpat lorem arcu eu eros. Mauris gravida euismod diam, eget finibus quam ornare non. Nam metus massa, porttitor id tempor et, pharetra id felis.";
    			t1 = space();
    			p1 = element("p");
    			p1.textContent = "In sed augue non metus volutpat ultricies in quis nisi. Donec sed placerat risus. Donec nec est turpis. Ut egestas ipsum eget lectus imperdiet dictum. Praesent congue dui nec turpis semper, pellentesque ullamcorper enim sodales. Quisque porttitor porta nibh, sit amet lacinia dui imperdiet et. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cras a enim eget elit cursus ullamcorper fringilla eu mi. Integer commodo est elit, eu mattis quam ultrices non. Fusce in sagittis elit. Curabitur in consequat est. Nulla mi lorem, tincidunt eget dapibus id, ultrices vel sem. Etiam fringilla cursus odio, nec cursus nisi commodo quis. Nullam nec neque vel turpis eleifend condimentum sed quis felis. Integer ut diam nibh.";
    		},
    		m(target, anchor) {
    ...
    // (13:8) <Tab id="tab1" tabActive class="page-content">
    ...
    // (20:8) <Tab id="tab2" class="page-content">
    ...
    class Subnavbar_1 extends SvelteComponent {
    	constructor(options) {
    		super();
