(function (global, factory) {
    ...
    (global = global || self, global.popup = factory(global.Framework7));
    ...
    /* public/packages/svelte/components/popup.svelte generated by Svelte v3.22.3 */
    ...
    /* src/pug/docs-demos/svelte/popup.svelte generated by Svelte v3.22.3 */
    ...
    // (11:10) <Button fill onClick={() => popupOpened = true}>
    ...
    // (14:10) <Button fill onClick={createPopup}>
    function create_default_slot_28(ctx) {
    	let t;

    	return {
    		c() {
    			t = text("Create Dynamic Popup");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (17:10) <Button fill popupOpen=".demo-popup-swipe">
    ...
    // (20:10) <Button fill popupOpen=".demo-popup-swipe-handler">
    function create_default_slot_26(ctx) {
    	let t;

    	return {
    		c() {
    			t = text("With Swipe Handler");
    		},
    		m(target, anchor) {
    			insert(target, t, anchor);
    		},
    ...
    // (23:10) <Button fill popupOpen=".demo-popup-push">
    ...
    function create_default_slot_24(ctx) {
    	...
    	const button4 = new Button({
    			props: {
    				fill: true,
    				popupOpen: ".demo-popup-swipe-handler",
    	...
    	return {
    		c() {
    			p0 = element("p");
    			p0.textContent = "Popup is a modal window with any HTML content that pops up over App's main content. Popup as all other overlays is part of so called \"Temporary Views\".";
    			t1 = space();
    			p1 = element("p");
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*popupOpened*/ 1) button1_changes.onClick = /*func*/ ctx[3];
    ...
    // (28:10) <Navbar title="Popup Title">
    ...
    function create_default_slot_20(ctx) {
    	...
    	return {
    		c() {
    			p0 = element("p");
    			p0.textContent = "Here comes popup. You can put here anything, even independent view with its own navigation. Also not, that by default popup looks a bit different on iPhone/iPod and iPad, on iPhone it is fullscreen.";
    			t1 = space();
    			p1 = element("p");
    ...
    // (26:6) <Popup class="demo-popup" opened={popupOpened} onPopupClosed={() => popupOpened = false}>
    ...
    // (43:10) <Navbar title="Swipe To Close">
    ...
    function create_default_slot_14(ctx) {
    	...
    	return {
    		c() {
    			...
    			t0 = space();
    			div = element("div");
    			div.innerHTML = `<p>Swipe me up or down</p>`;
    			set_style(div, "height", "100%");
    			attr(div, "class", "display-flex justify-content-center align-items-center");
    		},
    		m(target, anchor) {
    			mount_component(navbar, target, anchor);
    ...
    // (41:6) <Popup class="demo-popup-swipe" swipeToClose>
    ...
    function create_default_slot_11(ctx) {
    	...
    	return {
    		c() {
    			p0 = element("p");
    			p0.innerHTML = `<b>Swipe works only on this paragraph</b>`;
    			t1 = space();
    			p1 = element("p");
    			p1.textContent = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse faucibus mauris leo, eu bibendum neque congue non. Ut leo mauris, eleifend eu commodo a, egestas ac urna. Maecenas in lacus faucibus, viverra ipsum pulvinar, molestie arcu. Etiam lacinia venenatis dignissim. Suspendisse non nisl semper tellus malesuada suscipit eu et eros. Nulla eu enim quis quam elementum vulputate. Mauris ornare consequat nunc viverra pellentesque. Aenean semper eu massa sit amet aliquam. Integer et neque sed libero mollis elementum at vitae ligula. Vestibulum pharetra sed libero sed porttitor. Suspendisse a faucibus lectus.";
    			t3 = space();
    ...
    // (55:6) <Popup class="demo-popup-swipe-handler" swipeToClose swipeHandler=".swipe-handler">
    ...
    // (68:6) <Popup class="demo-popup-push" push>
    ...
    function create_default_slot_2$2(ctx) {
    	...
    	let t4;
    	let current;
    	const navbar = new Navbar({ props: { title: "Popup" } });
    	...
    	const popup0 = new Popup({
    			props: {
    				class: "demo-popup",
    				opened: /*popupOpened*/ ctx[0],
    				onPopupClosed: /*func_1*/ ctx[4],
    	...
    	return {
    		c() {
    			...
    			t4 = space();
    			create_component(popup3.$$.fragment);
    		},
    		m(target, anchor) {
    			mount_component(navbar, target, anchor);
    			insert(target, t0, anchor);
    			mount_component(block, target, anchor);
    			insert(target, t1, anchor);
    			mount_component(popup0, target, anchor);
    			insert(target, t2, anchor);
    			mount_component(popup1, target, anchor);
    			insert(target, t3, anchor);
    			mount_component(popup2, target, anchor);
    			insert(target, t4, anchor);
    			mount_component(popup3, target, anchor);
    			current = true;
    		},
    		p(ctx, dirty) {
    			const block_changes = {};

    			if (dirty & /*$$scope, popupOpened*/ 33) {
    				block_changes.$$scope = { dirty, ctx };
    			}

    			block.$set(block_changes);
    			const popup0_changes = {};
    			if (dirty & /*popupOpened*/ 1) popup0_changes.opened = /*popupOpened*/ ctx[0];
    			if (dirty & /*popupOpened*/ 1) popup0_changes.onPopupClosed = /*func_1*/ ctx[4];
    			...
    			const popup2_changes = {};

    			if (dirty & /*$$scope*/ 32) {
    				popup2_changes.$$scope = { dirty, ctx };
    			}

    			popup2.$set(popup2_changes);
    			const popup3_changes = {};

    			if (dirty & /*$$scope*/ 32) {
    				popup3_changes.$$scope = { dirty, ctx };
    			}

    			popup3.$set(popup3_changes);
    		},
    		i(local) {
    			if (current) return;
    			transition_in(navbar.$$.fragment, local);
    			...
    			transition_in(popup3.$$.fragment, local);
    			current = true;
    		},
    		o(local) {
    			transition_out(navbar.$$.fragment, local);
    			...
    			transition_out(popup3.$$.fragment, local);
    			current = false;
    		},
    		d(detaching) {
    			destroy_component(navbar, detaching);
    			...
    			destroy_component(block, detaching);
    			if (detaching) detach(t1);
    			destroy_component(popup0, detaching);
    			if (detaching) detach(t2);
    			destroy_component(popup1, detaching);
    			if (detaching) detach(t3);
    			destroy_component(popup2, detaching);
    			if (detaching) detach(t4);
    			destroy_component(popup3, detaching);
    		}
    	};
    }
    ...
    function instance$f($$self, $$props, $$invalidate) {
    	...
    	const func = () => $$invalidate(0, popupOpened = true);
    	const func_1 = () => $$invalidate(0, popupOpened = false);
    	return [popupOpened, createPopup, popup, func, func_1];
    }
